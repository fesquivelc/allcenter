        ...
        if len(invoice_line_gastos_ids) > 0:
            ...
            for line in self:
               ...
               #asiento = line.f_destino(invoice_line_gastos_ids)
                ...
                cuentas_destino = []
                producto = line.asset_id.invoice_id.invoice_line_ids.product_id
                price_unit_92 = 0.000
                price_unit_94 = 0.000
                price_unit_95 = 0.000
                price_unit_97 = 0.000
                ...
                if a == 1:
                    move_line_1 = {
                        'name': line.asset_id.invoice_id.invoice_line_ids.product_id.account_92_id.name,
                        'account_id': line.asset_id.invoice_id.invoice_line_ids.product_id.account_92_id.id,
                        'debit': price_unit_92,
                        'credit': 0.0,
                ...
                if b == 1:
                    move_line_2 = {
                        'name': line.asset_id.invoice_id.invoice_line_ids.product_id.account_94_id.name,
                        'account_id': line.asset_id.invoice_id.invoice_line_ids.product_id.account_94_id.id,
                ...
                if c == 1:
                    move_line_3 = {
                        'name': line.asset_id.invoice_id.invoice_line_ids.product_id.account_95_id.name,
                        'account_id': line.asset_id.invoice_id.invoice_line_ids.product_id.account_95_id.id,
                        'credit': 0.0 if float_compare(amount, 0.0, precision_digits=prec) > 0 else -amount,
                        'debit': price_unit_95,
                        'journal_id': journal_id,
                        'partner_id': partner_id,
                ...
                if d == 1:
                    move_line_4 = {
                        'name': line.asset_id.invoice_id.invoice_line_ids.product_id.account_97_id.name,
                        'account_id': line.asset_id.invoice_id.invoice_line_ids.product_id.account_97_id.id,
                        'credit': 0.0 if float_compare(amount, 0.0, precision_digits=prec) > 0 else -amount,
                        'debit': price_unit_97,
                        'journal_id': journal_id,
                        'partner_id': partner_id,
            ...
            if post_move and created_moves:
                created_moves.filtered(
                    lambda r: r.asset_id and r.asset_id.category_id and r.asset_id.category_id.open_asset).post()
...
class AccountAssetAsset(models.Model):
    ...
    porcentaje_annual = fields.Float(related='category_id.porcentaje_anual',
                                     string='Porcentaje Anual/Depreciacion Anual', default='category_id.porcentaje_anual')
    #porcentaje_amortizacion = fields.Float(string='Porcentaje Amortizacion/Depreciacion mensual',  digits=(3,2))
    porcentaje_amortizacion = fields.Float(related='category_id.method_percentage',
                                           string='Porcentaje Amortizacion/Depreciacion mensual',
