...
class BiosisContReportBcXlsx(ReportXlsx):
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        report_name = u"Balance de comprobación"
        ...
        sheet.merge_range('A1:L1', u'BALANCE DE COMPROBACION',format1)
        ...
        sheet.write_formula('C' + str(sumas_i), '{=SUM('+'C'+str(sumas_i-2)+':'+'C'+str(sumas_i-1)+')}', format_footer)
        sheet.write_formula('D' + str(sumas_i), '{=SUM('+'D'+str(sumas_i-2)+':'+'D'+str(sumas_i-1)+')}', format_footer)
        sheet.write_formula('E' + str(sumas_i), '{=SUM('+'E'+str(sumas_i-2)+':'+'E'+str(sumas_i-1)+')}', format_footer)
        sheet.write_formula('F' + str(sumas_i), '{=SUM('+'F'+str(sumas_i-2)+':'+'F'+str(sumas_i-1)+')}', format_footer)
        sheet.write_formula('G' + str(sumas_i), '{=SUM('+'G'+str(sumas_i-2)+':'+'G'+str(sumas_i-1)+')}', format_footer)
        sheet.write_formula('H' + str(sumas_i), '{=SUM('+'H'+str(sumas_i-2)+':'+'H'+str(sumas_i-1)+')}', format_footer)
        sheet.write_formula('I' + str(sumas_i), '{=SUM('+'I'+str(sumas_i-2)+':'+'I'+str(sumas_i-1)+')}', format_footer)
        sheet.write_formula('J' + str(sumas_i), '{=SUM('+'J'+str(sumas_i-2)+':'+'J'+str(sumas_i-1)+')}', format_footer)
        sheet.write_formula('K' + str(sumas_i), '{=SUM('+'K'+str(sumas_i-2)+':'+'K'+str(sumas_i-1)+')}', format_footer)
        sheet.write_formula('L' + str(sumas_i), '{=SUM('+'L'+str(sumas_i-2)+':'+'L'+str(sumas_i-1)+')}', format_footer)

BiosisContReportBcXlsx('report.biosis_cont_report.balance_comprobacion_xls.xlsx','account.balancecomprobacion')